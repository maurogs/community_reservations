...
c4 = h3.clients.create(name: 'Luis', lastname: 'Alfredo', password: 'asdf')
c5 = h3.clients.create(name: 'Marcos', lastname: 'Alfredo', password: 'asdf')
c6 = h3.clients.create(name: 'Ana', lastname: 'Jato', password: 'asdf')
c7 = h3.clients.create(name: 'Jana', lastname: 'Gil', password: 'asdf')
