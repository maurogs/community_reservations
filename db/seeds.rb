...
com1.spaces.create(id: 11, name: 'Tenis', open_hour: 9, close_hour: 23, description: 'Pista de tenis de tierra batida. Disponible con raquetas y pelotas', type_space: 'tenis')
com1.spaces.create(id: 12, name: 'Padel A', open_hour: 9, close_hour: 23, description: 'Pista de pádel A', type_space: 'padel')
com1.spaces.create(id: 13, name: 'Padel B', open_hour: 9, close_hour: 23, description: 'Pista de pádel B', type_space: 'padel')
com1.spaces.create(id: 14, name: 'Futbol', open_hour: 9, close_hour: 23, description: 'Campo de Fútbol con césped. Vestuarios disponibles. Pelotas no.', type_space: 'futbol')
com1.spaces.create(id: 15, name: 'Ping pong', open_hour: 9, close_hour: 23, description: 'Ping Pong, raquetas y pelota disponible.', type_space: 'ping pong')
com1.spaces.create(id: 16, name: 'Futbolín', open_hour: 9, close_hour: 23, description: 'Futbolín disponible para 1 hora', type_space: 'futbolin')

c1.reservations.create(name: 'Pedro', hour: 10, date: Time.now.to_date, space_id: 11)
c1.reservations.create(name: 'Pedro', hour: 12, date: Time.now.to_date, space_id: 16)

c2.reservations.create(name: 'María', hour: 16, date: Time.now.to_date, space_id: 15)

c3.reservations.create(name: 'Cristina', hour: 17, date: Time.now.to_date, space_id: 15)
c3.reservations.create(name: 'Cristina', hour: 20, date: Time.now.to_date, space_id: 16)

c4.reservations.create(name: 'Luis', hour: 9, date: Time.now.to_date, space_id: 12)
